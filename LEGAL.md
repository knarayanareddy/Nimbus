...
- Parametric products pay based on **pre-defined triggers**, not actual loss.
- There is **no guarantee** of payout even if the user experiences weather-related loss.
- The protocol is experimental and carries **significant financial and technical risk**.

---

## 2. Regulatory Classification

Parametric weather products may be classified differently across jurisdictions:

- **United States**: May be considered insurance or derivatives in some states. Users are responsible for compliance.
...
- Network congestion or Solana validator issues
- Loss of private keys

### Economic Risks
- Premium paid may significantly exceed any payout received
- Pool insolvency in extreme scenarios
- Illiquidity of LP positions

### Regulatory Risks
- Future regulatory actions may restrict or prohibit use of the protocol
- Tax obligations on premiums or payouts
...
## 5. KYC / AML Policy (Future)

For institutional or high-value policies (> $50,000 equivalent), the protocol may require:

- Identity verification (KYC)
- Source of funds attestation
- Sanctions screening

These controls will be implemented off-chain via a compliant service provider.

**Retail users** are not currently subject to KYC requirements.
...
- Changes to LTV limits and risk parameters

Governance will be implemented via a DAO with token-weighted voting.
...
- Legal entity formation in a favorable jurisdiction (under review)
